...
const TableBooking = () => {
    ...
    return (
        <div>
            <div className="text-white pt-[30px] lg:pt-[120px] !max-w-[1200px] m-auto">
                <div>
                    ...
                    <p className="lg:w-[485px]">Enim tempor eget pharetra facilisis sed maecenas adipiscing. Eu leo
                        molestie
