    ...
    return (
        <section className="footer_container">
            <div className="text-white text-center">
                <h2 className="text-3xl lg:text-4xl font-bold mb-8 uppercase mb-[48px] mt-[16px]">We ready to have you
                    the best dining
                    experiences
                </h2>
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
                    {
                        footerData.map((items) => (
                            <div key={items.id} className="flex flex-col justify-center items-center mb-10 lg:mb-0">
                ...
                <div className="flex flex-col justify-center items-center pt-[120px]">
                    <div className="flex mb-[25px] flex-wrap">
                        <div
                            className="flex justify-center items-center border-2 border-white rounded-full p-3 me-[24px]">
